...
\begin{equation}
  \label{eq:22}
\left(1+{\bra{q_0}|\tilde{V}-\tilde{V}_{w}\ket{q_0}\over q_0(1/\omega_r^2-1)}\right)\int w_pdp  =\sum_{q=\pm q_0}{-i\pi\bra{q}|\tilde{V}\ket{4}  \over
...
\begin{equation}
  \label{eq:23}
  C \equiv \left(1+{\bra{q_0}|\tilde{V}-\tilde{V}_{w}\ket{q_0}\over q_0(1/\omega_r^2-1)}\right).
\end{equation}
