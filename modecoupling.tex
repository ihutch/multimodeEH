...
\ref{modeplots}.
\begin{figure}\center
  \includegraphics[width=0.6\hsize]{fig1}
...
\begin{figure}
  \centering\includegraphics[width=0.7\hsize]{fig2}
...
values of $\psi$.
\begin{figure}
  \includegraphics[width=.48\hsize]{fig3a}\hskip-2em(a)\quad
  \includegraphics[width=.48\hsize]{fig3b}\hskip-2em(b)\ 
...
\begin{figure}
  \includegraphics[width=0.48\hsize]{fig4a}\hskip -2em(a)\quad 
  \includegraphics[width=0.48\hsize]{fig4b}\hskip -2em(b)\ 
...
growth rate slightly exceeds the shiftmode. The mechanisms governing
the instability are the same as those identified in shiftmode
analysis (\cite{Hutchinson2018,Hutchinson2019}).

The intermediate field regime is illustrated in Fig.\ \ref{intermed}.
\begin{figure}
  \includegraphics[width=0.42\hsize]{fig5a}\hskip-2em(a)\quad
  \includegraphics[width=0.56\hsize]{fig5b}\hskip-2em(b)\ 
...
\begin{figure}
  \center  \includegraphics[width=.5\hsize]{fig6}
...
\begin{figure}
  \center  \includegraphics[width=.5\hsize]{fig7}
