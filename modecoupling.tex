...
If it is true that $\bra{q}|(\tilde{V}-\tilde{V}_{ext})\ket{q} \sim 20
...
$$
(\lambda_q-\lambda_\perp  +\tilde{V}_{ext}
  +\bra{q}|(\tilde{V}-\tilde{V}_{ext})\ket{q}\int w_pdp/w_q).
$$
